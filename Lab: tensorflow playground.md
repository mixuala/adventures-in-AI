...
3. **regularization**: improve accuracy on test data by preventing the network from learning strong weights
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0MzkxMTUzNSwtNjgyMjYzNjYxLDY5OT
